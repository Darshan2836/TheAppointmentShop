...
import com.example.login.OTPverification;
import com.example.login.PhoneNumber;
...
public class AppointmentBill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointment_bill);
        ...
        progressDialog = new ProgressDialog(AppointmentBill.this);
